...
function reset_button() {
    return __awaiter(this, void 0, void 0, function () {
        var driver, resetButton, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    // Navigate to the app
                    return [4 /*yield*/, driver.get('http://localhost:4200/home')];
                case 3:
                    // Navigate to the app
                    _a.sent();
                    logToFile('Navigated to http://localhost:4200/home');
                    return [4 /*yield*/, driver.wait(selenium_webdriver_1.until.elementLocated(selenium_webdriver_1.By.css('#button')), 10000)];
                case 4:
                    resetButton = _a.sent();
                    // Click the login button
                    return [4 /*yield*/, resetButton.click()];
                case 5:
                    // Click the login button
                    _a.sent();
